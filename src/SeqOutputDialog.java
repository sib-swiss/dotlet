...
public class SeqOutputDialog extends Frame
{
	...
	void searchSequences()
	{
		...
		if(MouseSelectionMisc.width > 0 && MouseSelectionMisc.height > 0)
		{
			...
			if(MouseSelectionMisc.width > MouseSelectionMisc.height)
			{
				...
				this.startRef = MouseSelectionMisc.startY;
				this.endRef = MouseSelectionMisc.endY;
				startOther = MouseSelectionMisc.startX;
				seqLength = this.endRef - this.startRef;
			...
			else
			{
				...
				this.startRef = MouseSelectionMisc.startX;
				this.endRef = MouseSelectionMisc.endX;
				seqLength = this.endRef - this.startRef;
			...
			searchDiagonals(startOther, endOther, this.startRef, this.endRef, vertRef, 
			...
			String nameSeq)
	{
		...
		{
			if ( this.seqPairWidget.hsName.equals(nameSeq) && this.startRef==startSeq && this.endRef==(endSeq-window) )
			{
